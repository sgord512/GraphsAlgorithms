define(['deps/under', 'deps/d3', 'lib/algorithms/greedy/huffman', 'lib/utilities/d3_helper'], function(underscore, d3, Huffman, d3_helper) {
    ...
    return function() {
        ...
        var freqs = {  'english': {'e': 12.702 ,'t': 9.056 ,'a': 8.167 ,'o': 7.507 ,'i': 6.966 ,'n': 6.749 ,'s': 6.327 ,'h': 6.094 ,'r': 5.987 ,'d': 4.253 ,'l': 4.025 ,'c': 2.782 ,'u': 2.758 ,'m': 2.406 ,'w': 2.360 ,'f': 2.228 ,'g': 2.015 ,'y': 1.974 ,'p': 1.929 ,'b': 1.492 ,'v': 0.978 ,'k': 0.772 ,'j': 0.153 ,'x': 0.150 ,'q': 0.095 ,'z': 0.074 }
                       ,'french': {'e': 17.134 ,'a': 8.122 ,'s': 7.948 ,'i': 7.579 ,'t': 7.244 ,'n': 7.095 ,'r': 6.553 ,'u': 6.369 ,'l': 5.456 ,'o': 5.398 ,'d': 3.669 ,'c': 3.345 ,'p': 3.021 ,'m': 2.968 ,'v': 1.628 ,'q': 1.362 ,'f': 1.066 ,'b': 0.901 ,'g': 0.866 ,'h': 0.737 ,'j': 0.545 ,'x': 0.387 ,'y': 0.308 ,'z': 0.136 ,'w': 0.114 ,'k': 0.049 }
        };

        var huffman = Huffman.initialize(freqs.english);

        var transform_string = d3_helper.transforms.translation;
        ...
        function draw(huff) {
            ...
            create(groups.enter(),
                   create_x_function_from_roots(nodes),
                   create_y_function(max_h),
                   create_scale_r(nodes));
        }
